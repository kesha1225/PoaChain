...
# TODO:
# придумать идеальный генезис блок для тестов (хеш посчитать)
# (а то если писать хуйню потом никто не засинкается)
# если транзак еще не подтверждена чтобы обзорщик транзы не падал
